...
## 3. Decoupled API Backend + SPA / Client Architecture
The frontend (SPA/MPA/mobile) communicates with one or more backend API services. This is often implemented with microservices.

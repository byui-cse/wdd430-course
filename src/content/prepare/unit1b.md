...
1. [Performance Inequality Gap](https://infrequently.org/series/performance-inequality/) This is actually a list of articles. Review at least one of the annual reports and scan through a couple of the other articles.
2. [Chrome Performance metrics](https://krausest.github.io/js-framework-benchmark/index.html). How many frontend frameworks perform on Chrome.
3. [State of the Web](https://httparchive.org/reports/state-of-the-web)
4. [If not React then What?](https://infrequently.org/2024/11/if-not-react-then-what/) Make sure to read the footnotes as well.
5. [Spec Driven Development activity](../../ponder/spec-driven) Review the workflow for drafting and refining a project specification with a general AI model.
